...
class AccountInvoiceRefund(models.TransientModel):
    ...
    use_percentage = fields.Boolean('Make % refund')
    percentage = fields.Float('Refund in %')
    ...
    @api.onchange('use_percentage')
    @api.depends('percentage')
    def _onchange_use_percentage(self):
